...
final class ClipTapeAppModel {
    ...
    func chooseSaveDirectory() -> Bool {
        ...
        panel.title = "Choose where ClipTape saves recordings"
        panel.prompt = "Choose"
        ...
        do {
            ...
            recordingState = .failed(
                "ClipTape could not remember access to that folder. Choose another folder and try again."
            )
            return false
        }
    }

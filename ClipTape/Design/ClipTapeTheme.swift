...
struct ClipTapeTextModifier: ViewModifier {
    let style: ClipTapeTextStyle
...
extension View {
    func clipTapeText(_ style: ClipTapeTextStyle) -> some View {
        modifier(ClipTapeTextModifier(style: style))
    }
}
